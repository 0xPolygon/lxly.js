export default [
        ...
        "inputs": [
            {
                ...
                "components": [
                    ...
                    {
                        "name": "settlementTokenDestinationAddress",
                        "type": "address",
                        "internalType": "address"
                    },
                    {
                        "name": "settlementTokenDestinationPermitData",
                        "type": "bytes",
                        "internalType": "bytes"
                    },
                    {
                        "name": "settlementTokenDestinationAmount",
                        "type": "uint256",
                        "internalType": "uint256"
                    },
                    {
    ...
    {
        "type": "error",
        "name": "CannotNotReturnExcessiveMessageValueToYou",
        "inputs": []
    },
    {
        "type": "error",
        "name": "CannotRefuelGas",
        "inputs": []
    },
    {
        "type": "error",
    ...
    {
        "type": "error",
        "name": "SwapFailedBecauseDexReverted",
        "inputs": [
            {
                "name": "reason",
                "type": "bytes",
    ...
    {
        "type": "error",
        "name": "ThisFunctionIsOnlyCallableByGasPorter",
        "inputs": []
    },
    {
        "type": "error",
